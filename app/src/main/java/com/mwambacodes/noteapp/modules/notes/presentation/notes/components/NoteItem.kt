package com.mwambacodes.noteapp.modules.notes.presentation.notes.components
...
fun NoteItem(
    ...
    Box(
        ...
        IconButton(
            ...
            Icon(imageVector = Icons.Default.Delete, contentDescription = "Delete Note", tint = Color.DarkGray)
        }
    }
